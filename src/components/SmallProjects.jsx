    ...
    <div className='px-20 min-h-screen'>
      ...
      <div className="card-warp grid grid-cols-12 gap-4">
        {SmallProjectsData.map((project, index) => {
          return (<div key={index} className="card col-span-4 bg-[#112240] p-6">
            <div className="links flex gap-4 justify-end items-center">
             ...
             <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="hover:text-[#64FFDA] feather feather-external-link"><title>External Link</title><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
             </div>
            </div>
            ...
            <div className="flex gap-6 py-2 text-zinc-600 font-bold">{project.techs.toString()}</div>
          </div>)
